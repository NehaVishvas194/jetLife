  ...
  const UpBooking = async (bookingType = "0") => {
    try {
      ...
      console.log("My Upcomming Booking Data:-", response.data.data);
       const Upbookings = Array.isArray(response.data?.data)
        ? response.data.data
        : [];
      setUpCommingBooking(Upbookings);
    } catch (error) {
      console.error(error);
    }
  };
                    ...
                    <div className="card-body">
                      <div className="tab">
                        <div className="tab__list">
                          <div
                            className={`tab__item ${
                              activeFlightTab === "upcoming" ? "is--active" : ""
                            }`}
                    ...
                    <div className="card-body">
                      <div className="tab">
                        ...
                        <div className="tab__list">
                          <div
                            className={`tab__item ${
                              activeHotelTab === "upcoming" ? "is--active" : ""
                            }`}
                          ...
                          <div
                            className={`tab__item ${
                              activeHotelTab === "cancelled" ? "is--active" : ""
                            }`}
                          ...
                          <div
                            className={`tab__item ${
                              activeHotelTab === "completed" ? "is--active" : ""
                            }`}
