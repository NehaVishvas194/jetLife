          ...
          <div className="row">
            <div className="col-md-12 mb-5">
              ...
              <div className="stepper" id="stepper">
                ...
                <div className="step">
                  ...
                  <div className="label">Select your seat</div>
                </div>
                <div className="line"></div>
                <div className="step">
                  <div className="circle">5</div>
                  <div className="label">Check and pay</div>
                </div>
              </div>
              {/* <!-- </div>
                    </div> --> */}
            ...
            <div className="col-md-12">
              <div className="from-to-main">
                ...
                <p>Round-trip | 1 traveler | Sat, Jul 19 - Sat, Jul 26</p>
              </div>
            </div>
            <div className="col-md-12">
                    ...
                    <div className="col-md-4">
                      <div className="card booking-card">
                        <div className="card-body">
                          ...
                          <div className="price">
                            Total price <strong>INR 62,067.94</strong>
                          </div>
                    ...
                    <div className="col-md-4">
                      ...
                      <div className="card booking-card">
                        <div className="card-body">
                          ...
                          <div className="price">
                            Total price <strong>INR 70,136.77</strong>
                          </div>
                          <div className="features">
                            <p>
                              <span>
                            ...
                            <p>
                              ...
                              No change fees – pay only the fare difference, if
                              any
                            </p>
                          </div>
                    ...
                    <div className="col-md-4">
                      ...
                      <div className="card booking-card">
                        <div className="card-body">
                          ...
                          <div className="price">
                            Total price <strong>INR 74,481.53</strong>
                          </div>
                          <div className="features">
                            <p>
                              <span>
                    ...
                    <div className="card-body">
                      <div className="d-flex justify-content-between">
                        <div className="enter-detail">
                          ...
                          <p>Add traveler details and review baggage options</p>
                        </div>
                        <div className="">
                          <button
                                ...
                                <div className="row">
                                  <div className="col-md-6">
                                    <div className="field-set">
                                      ...
                                      />
                                      <p>
                                        *Enter exactly what's written on this
                                        traveler's travel document
                                      </p>
                                    </div>
                                  </div>
                                  <div className="col-md-6">
                                  ...
                                  <div className="col-md-6">
                                    <div className="field-set">
                                      ...
                                      <p>
                                        *We're currently required by airlines
                                        and providers to ask for this
                                        information
                                      </p>
                                    </div>
                                  </div>
                                ...
                                <div className="card-body">
                                  <table className="w-100">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td>
                                          <strong>Preferred className:</strong>
                                        </td>
                                        <td>Economy</td>
                                      </tr>
                                    </tbody>
                    ...
                    <div className="card-body">
                      ...
                      <div className="row">
                        <div className="col-md-6">
                            ...
                            <div className="card-body">
                              <div className="d-flex gap-3">
                                ...
                                <div className="fli-del">
                                  ...
                                  <p>
                                    Sat, Jul 26 · 11:40 AM - Sat, Jul 26 · 1:55
                                    PM
                                  </p>
                          ...
                          <div className="my-3">
                            <p>
                              You selected the Eco Value fare for all flights in
                              this trip. <a href="">Check what’s included</a>
                            </p>
                          </div>
                          <div className="my-3">
                            <div className="card">
                          ...
                          <div className="my-3">
                            <div className="card">
                              ...
                              <div className="card-body">
                                ...
                                <p>
                                  Flexible ticket Change your time or date up to
                                  24 hours before departure and only pay the
                                  difference, if any <a href="">View Details</a>
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="my-3">
                            <p>
                              For more detailed baggage info and options, check
                              airline baggage policies: <a href="">Air India</a>
                            </p>
                          </div>
                          <div className="my-3">
                            <div className="card">
