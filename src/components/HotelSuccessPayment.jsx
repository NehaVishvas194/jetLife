  ...
  useEffect(() => {
    const verifyPayment = async () => {
      ...
      try {
        ...
        const res = await axios.post(`${API_BASE_URL}/verify/token`, payload, {
          headers: { "Content-Type": "application/json" },
        });
        console.log("Verify Hotel Token Response:", res.data);
        if (res.data?.API3G?.Result === "000") {
          setStatus("✅ Payment Successfully!");
...
export default HotelSuccessPayment;
